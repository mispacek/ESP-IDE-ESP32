...
def wget(url="",path=""):
    ...
    if filename != correc_filename:
        print("Chybne zadan nazev souboru, automaticky opraven na:" + correc_filename)
    ...
    try:
        ...
        if res.status_code == 200:
            ...
            print("Chyba:",res.status_code)
    except Exception as e:
        print("Error, exception: {0}".format(e))

print("Stahuji ide_1_20.tar")
wget(url="http://iotserver.cz/ide/ide_1_20.tar",path="")

print("Stahuji install_1_20.py")
wget(url="http://iotserver.cz/ide/install_1_20.py",path="")

print("Spoustim instalator...")
import install_1_20.py
